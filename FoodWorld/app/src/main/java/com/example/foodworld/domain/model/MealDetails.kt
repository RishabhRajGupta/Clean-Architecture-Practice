package com.example.foodworld.domain.model
...
class MealDetails(
    ...
    /**
     * Zips the ingredients and measures together, filtering out any empty ones.
     * Returns a list of Pairs, e.g., [("Flour", "1 cup"), ("Eggs", "2")]
     */
    fun getIngredientsWithMeasures(): List<Pair<String, String>>{
        ...
        return ingredients.zip(measures).filter { it.first.isNotBlank() }
    }
}